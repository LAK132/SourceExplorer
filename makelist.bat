...
@REM set CXX=cl /nologo /std:c++17 /D_CRT_SECURE_NO_WARNINGS /DNOMINMAX /DUNICODE /MT /EHsc /Zc:rvalueCast /Zc:wchar_t /Zc:ternary Gdi32.lib Opengl32.lib /DLAK_USE_WINAPI
set CXX=cl /nologo /std:c++17 /D_CRT_SECURE_NO_WARNINGS /DNOMINMAX /DUNICODE /MT /EHsc /Zc:rvalueCast /Zc:wchar_t /Zc:ternary /DLAK_USE_SDL
