...
link /DEBUG /nologo /out:out\srcexplr.exe bin\srcexplr.obj bin\imgui_glfw.obj bin\imgui.obj bin\imgui_demo.obj bin\imgui_draw.obj bin\miniz.obj bin\memorystream.obj bin\explorer.obj bin\image.obj bin\gl3w.obj lib\glfw3dll.lib lib\glfw3.lib 
